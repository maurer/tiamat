...
def create_makefile(cwe, is_dir_split):
	...
	contents += "C_SOURCES=$(filter-out $(wildcard CWE*w32*.c) $(wildcard CWE*wchar_t*.c),$(wildcard CWE*.c))\n"
	contents += "C_OBJECTS=$(C_SOURCES:.c=.o)\n"

	contents += "\n# only grab the .cpp files without \"w32\" or \"wchar_t\" in the name\n"
	contents += "CPP_SOURCES=$(filter-out $(wildcard CWE*w32*.cpp) $(wildcard CWE*wchar_t*.cpp),$(wildcard CWE*.cpp))\n"
