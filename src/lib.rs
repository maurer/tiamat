...
pub fn uaf_stage1(holmes: &mut Engine) -> Result<()> {
    holmes_exec!(holmes, {
        ...
        rule!(flow_stack_push: stack(stack2, stack, cur_name, fall) <= path_alias([_], [_], stack, cur_name, cur, var, [_]) & lift(cur_name, cur, sema, fall) & call_site(cur_name, cur, next_name, [_]), {
